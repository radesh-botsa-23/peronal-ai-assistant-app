...
- "intent": one of "search_emails", "reply_email", "summarize_emails", "important_emails", "action_items", "daily_report", "meeting_prep", "todays_meetings", "upcoming_meetings", "meeting_summary", "recent_meetings", "search_teams", "search_whatsapp", "summarize_whatsapp", "general_query", "unknown"
...
- "reply_email" = user wants to reply to an email (e.g. 'reply to sameer saying yes I will be there')
