...
export async function transcribeAudio(audioBuffer, mimeType = "audio/ogg") {
  ...
  const prompt = `Transcribe this audio message accurately. Return ONLY the transcribed text, nothing else. If you cannot understand the audio clearly, prefix with [LOW CONFIDENCE] followed by your best attempt.`;
