 ...
 * @param {string} eventData.title - Event summary/title
 * @param {string} eventData.start - ISO 8601 start time
 * @param {string} eventData.end - ISO 8601 end time
 * @param {string} [eventData.description] - Event description
 * @param {string} [eventData.location] - Event location
 * @returns {Promise<object>} The created event mapping
 */
